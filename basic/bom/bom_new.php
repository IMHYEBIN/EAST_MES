...
<body>
    <!-- ////////////////////////////////////////////상단 섹션/////////////////////////////////////////////// -->
    <div class="container">
        <form method="post" action="/basic/bom/pop1/top_view.php" target="top_frame">
            ...
            <div class="table_section1">
                ...
                <!-- 상단 VIEW -->
                <iframe frameborder="0" class="top_frame" name="top_frame" src="/basic/bom/pop1/top_view.php"></iframe>
            </div>
        </form>
