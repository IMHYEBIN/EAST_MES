...
<body>
    <form method="post" target="view_frame" action="bom_view.php">
        <div class="container">
            ...
            <div class="table-section">
                ...
                <iframe frameborder="0" name="tree_frame" src="bom_tree.php"></iframe>
                <iframe frameborder="0" name="view_frame" src="bom_view.php"></iframe>
    ...
    <script type="text/javascript">
        function popupNew() {
            ...
            window.open("bom_new.php", "bom_new", "width=1110, height=200, top=200, left=100");
