...
<body>
    <form method="post" target="view_frame" action="maker_view.php">
        <div class="container">
            ...
            <div class="table-section">
                <div class="table-header">
                    ...
                    <div class="th2">MAKER명</div>
                    <div class="th_btn">관리</div>
                </div>

                <iframe frameborder="0" name="view_frame" src="maker_view.php"></iframe>
    ...
    <script type="text/javascript">
        function popupNew() {
            ...
            window.open("maker_new.php", "maker_new", "width=600, height=180, top=200, left=100");
