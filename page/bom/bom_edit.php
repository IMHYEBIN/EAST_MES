...
<body>
    <!-- ////////////////////////////////////////////상단 섹션/////////////////////////////////////////////// -->
    <div class="container">
        <form method="post" action="/page/bom/pop1/top_view_edit.php" target="top_frame">
            ...
            <div class="table_section1">
                ...
                <!-- 상단 VIEW -->
                <iframe frameborder="0" class="top_frame" name="top_frame" src="/page/bom/pop1/top_view_edit.php"></iframe>
            </div>
        </form>
