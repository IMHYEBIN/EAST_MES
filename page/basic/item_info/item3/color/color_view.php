...
$sql = "select * from item3_color order by id desc";
...
<head>
    ...
    <link rel="stylesheet" href="css/color_view.css">
...
<body>
    ...
    <table>
        ...
        for (; $row = mysqli_fetch_array($res);) {
            ...
            <form action='color_edit.php' method='post' target='color_edit'>
    ...
    <script type="text/javascript">
        function popup_edit() {
            ...
            window.open("color_edit.php", "color_edit", "width=600, height=180, top=200, left=100");
