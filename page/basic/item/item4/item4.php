...
<body>
    <form method="post" target="view_frame" action="item4_view.php">
        <div class="container">
            ...
            <div class="table-section">
                ...
                <iframe frameborder="0" name="view_frame" src="item4_view.php"></iframe>
    ...
    <script type="text/javascript">
        function popupNew() {
            ...
            window.open("item4_new.php", "item4_new", "width=1110, height=320, top=200, left=100");
