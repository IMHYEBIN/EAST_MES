...
<body>
    <!-- ////////////////////////////////////////////상단 섹션/////////////////////////////////////////////// -->
    <div class="container">
        <form method="post" action="/page/basic/bom/pop1/top_view_edit.php" target="top_frame">
            ...
            <div class="table_section1">
                ...
                <!-- 상단 VIEW -->
                <iframe frameborder="0" class="top_frame" name="top_frame" src="/page/basic/bom/pop1/top_view_edit.php"></iframe>
            </div>
        </form>
        ...
        <div class="bottom_section">
            <div class="table_section2">
                <!-- ////////////////////////////////////////////하단 섹션/////////////////////////////////////////////// -->
                <form method="post" action="/page/basic/bom/pop1/bottom_view.php" target="bottom_frame">
                    <div class="header2_1">
                    ...
                    <!-- 하단 VIEW -->
                    <iframe frameborder="0" class="bottom_frame" name="bottom_frame" src="/page/basic/bom/pop1/bottom_view.php"></iframe>
                </form>
            </div>
            ...
            <div class="add_section">
                ...
                <form action='/page/basic/bom/pop1/php/bottom_view_insert.php' method='post' target='bottom_view'>
